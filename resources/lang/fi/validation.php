...
return [
    ...
    */
    ...
    "after_or_equal" =>
        "Kentän :attribute päiväyksen tulee olla sama ja jälkeen :date",
    "alpha" => "Kenttä :attribute voi sisältää vain kirjaimia.",
    "alpha_dash" =>
        "Kenttä :attribute voi sisältää vain kirjaimia, numeroita ja viivoja.",
    "alpha_num" =>
        "Kenttä :attribute voi sisältää vain kirjaimia ja numeroita.",
    "array" => "Kenttä :attribute tulee olla taulukko.",
    "before" => "Kentän :attribute päiväyksen tulee olla ennen :date.",
    "before_or_equal" =>
        "Kentän :attribute päiväyksen tulee olla sama tai ennen kuin :date.",
    "between" => [
        ...
        "array" =>
            "Kentän :attribute tulee sisältää välillä :min - :max arvoa.",
    ],
    "boolean" => "Kentän :attribute arvon tulee olla tosi tai epätosi.",
    "confirmed" => "Kentän :attribute vahvistus ei täsmää.",
    "current_password" => "Syötetty salasana ei vastaa nykyistä salasanaasi.",
    ...
    "gt" => [
        ...
        "file" =>
            "Tiedoston :attribute tulee olla suurempi kuin :value kilotavua.",
        "string" =>
            "Kentän :attribute arvo tulee olla pidempi kuin :value merkkiä.",
        "array" =>
            "Kentän :attribute tulee sisältää enemmän kuin :value arvoa.",
    ],
    "gte" => [
        "numeric" =>
            "Kentän :attribute arvo tulee olla suurempi tai yhtäsuuri kuin :value.",
        "file" =>
            "Tiedoston :attribute tulee olla suurempi tai yhtäsuuri kuin :value kilotavua.",
        "string" =>
            "Kentän :attribute arvo tulee olla pidempi tai yhtä pitkä kuin :value merkkiä.",
    ...
    "lt" => [
        ...
        "file" =>
            "Tiedoston :attribute tulee olla pienempi kuin :value kilotavua.",
        "string" =>
            "Kentän :attribute arvo tulee olla lyhyempi kuin :value merkkiä.",
        "array" =>
            "Kentän :attribute tulee sisältää vähemmän kuin :value arvoa.",
    ],
    "lte" => [
        "numeric" =>
            "Kentän :attribute arvo tulee olla pienempi tai yhtäsuuri kuin :value.",
        "file" =>
            "Tiedoston :attribute tulee olla pienempi tai yhtäsuuri kuin :value kilotavua.",
        "string" =>
            "Kentän :attribute arvo tulee olla lyhyempi tai yhtä pitkä kuin :value merkkiä.",
        "array" =>
            "Kentän :attribute tulee sisältää :value arvoa tai vähemmän.",
    ],
    "max" => [
        "numeric" => "Kentän arvon :attribute tulee olla enintään :max.",
        "file" => "Tiedoston :attribute tulee olla enintään :max kilobittiä.",
        "string" =>
            "Kentän :attribute arvon tulee olla enintään :max merkkiä pitkä.",
        "array" =>
            "Kentän :attribute ei tule sisältää enempää kuin :max arvoa.",
    ],
    "mimes" => "Kentän :attribute arvon tulee olla tiedostotyyppiä: :values.",
    "mimetypes" =>
        "Kentän :attribute arvon tulee olla tiedostotyyppiä: :values.",
    "min" => [
        "numeric" => "Kentän :attribute arvon tulee olla vähintään :min.",
        "file" => "Tiedoston :attribute tulee olla vähintään :min kilobittiä.",
        "string" =>
            "Kentän :attribute arvon tulee olla vähintään :min merkkiä.",
    ...
    "required_unless" =>
        "Kenttä :attribute vaaditaan jos :other ei sisälly arvoihin :values.",
    "required_with" =>
        "Kenttä :attribute vaaditaan kun arvo :values on annettu.",
    "required_with_all" =>
        "Kenttä :attribute vaaditaan kun arvo :values on annettu.",
    "required_without" =>
        "Kenttä :attribute vaaditaan kun arvoa :values ei ole annettu.",
    "required_without_all" =>
        "Kenttä :attribute vaaditaan kun mitään arvoista :values ei ole annettu.",
    ...
    "starts_with" =>
        "Attribuutin :attribute tulee alkaa yhdellä seuraavista: :values",
    "string" => "Kentän :attribute arvon tulee olla tekstiä.",
    "timezone" =>
        "Kentän :attribute arvon tulee olla validi aikavyöhyketunniste.",
